module.exports = Object.freeze({
  TOKEN: '1189429160:AAFzqeFaBXSi8IzOKEgTsu2uEeABWKaXqFQ', //required
  ARIA_SECRET: 'bhadoo', //change as per needs.
  ARIA_DOWNLOAD_LOCATION: '/app/downloads)', //-leave as it is
  INDEX_DOMAIN: 'https://hypercianstand.veis.workers.dev/', // replace with your index domain. use https://github.com/ParveenBhadooOfficial/go-drive
  ...
  GDRIVE_PARENT_DIR_ID:  '1BEfBB3aXeEdtEF3nIexdX2lOQOZyCafW', // for directorty eg. https://drive.google.com/drive/folders/1p7pHhSh2yboWePmo53DnVr3xkAYiojP9 use 1p7pHhSh2yboWePmo53DnVr3xkAYiojP9
  ...
  AUTHORIZED_CHATS: [-1001448666724],	// Telegram chat IDs. Anyone in these chats can use the bot. Add https://t.me/YourTGid_Bot to Group and click /id
  ...
  DOWNLOAD_NOTIFY_TARGET: {  // Information about the web service to notify on download completion. not required
    ...
    COMMANDS_USE_BOT_NAME: {
      ...
      NAME: "@LooCH_CLouD_02_BoT" //Enter your Bot Username here if above is set to true.
    }
});
