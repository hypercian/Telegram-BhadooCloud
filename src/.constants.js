module.exports = Object.freeze({
  TOKEN: '1083395426:AAF4Voc0wg0NKA9xclaEWKTAorNWetnP4Gk', //required
  ...
  GDRIVE_PARENT_DIR_ID:  '19bdTyHCa4C18WONnEtcQ1hhXW6AHU_HP', // for directorty eg. https://drive.google.com/drive/folders/1p7pHhSh2yboWePmo53DnVr3xkAYiojP9 use 1p7pHhSh2yboWePmo53DnVr3xkAYiojP9
  ...
  DOWNLOAD_NOTIFY_TARGET: {  // Information about the web service to notify on download completion. not required
    ...
    COMMANDS_USE_BOT_NAME: {
      ...
      NAME: "@LooCH_CLouD_BoT" //Enter your Bot Username here if above is set to true.
    }
});
