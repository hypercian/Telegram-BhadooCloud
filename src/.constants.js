module.exports = Object.freeze({
  TOKEN: '1191462929:AAG6k108np5xIJupdrwX_WM36QUrPzW_r30', //required
  ARIA_SECRET: 'bhadoo', //change as per needs.
  ARIA_DOWNLOAD_LOCATION: '/app/downloads)', //-leave as it is
  INDEX_DOMAIN: 'https://hyhadi.veis.workers.dev/06/', // replace with your index domain. use https://github.com/ParveenBhadooOfficial/go-drive
  ...
  GDRIVE_PARENT_DIR_ID:  '1-pHN6z1F-ZvbNHY8lKIcLfmokXPvmy9Z', // for directorty eg. https://drive.google.com/drive/folders/1p7pHhSh2yboWePmo53DnVr3xkAYiojP9 use 1p7pHhSh2yboWePmo53DnVr3xkAYiojP9
  ...
  AUTHORIZED_CHATS: [-1001228754152],	// Telegram chat IDs. Anyone in these chats can use the bot. Add https://t.me/YourTGid_Bot to Group and click /id
  ...
  DOWNLOAD_NOTIFY_TARGET: {  // Information about the web service to notify on download completion. not required
    ...
    COMMANDS_USE_BOT_NAME: {
      ...
      NAME: "@LooCH_CLouD_06_BoT" //Enter your Bot Username here if above is set to true.
    }
});
