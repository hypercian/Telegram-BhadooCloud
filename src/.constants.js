module.exports = Object.freeze({
  TOKEN: '1294348940:AAG4bXqc68bGsi7LVdcR0OO3ABEErAzDKZY', //required
  ARIA_SECRET: 'bhadoo', //change as per needs.
  ARIA_DOWNLOAD_LOCATION: '/app/downloads)', //-leave as it is
  INDEX_DOMAIN: 'https://hypercianclash.veis.workers.dev/DaNi/', // replace with your index domain. use https://github.com/ParveenBhadooOfficial/go-drive
  ...
  GDRIVE_PARENT_DIR_ID:  '1Q2x9ji78JQtzwHgGPjcbclSuwcEI_6uf', // for directorty eg. https://drive.google.com/drive/folders/1p7pHhSh2yboWePmo53DnVr3xkAYiojP9 use 1p7pHhSh2yboWePmo53DnVr3xkAYiojP9
  ...
  AUTHORIZED_CHATS: [-1001457826113],	// Telegram chat IDs. Anyone in these chats can use the bot. Add https://t.me/YourTGid_Bot to Group and click /id
  ...
  DOWNLOAD_NOTIFY_TARGET: {  // Information about the web service to notify on download completion. not required
    ...
    COMMANDS_USE_BOT_NAME: {
      ...
      NAME: "@LooCH_CLouD_03_BoT" //Enter your Bot Username here if above is set to true.
    }
});
