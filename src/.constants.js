module.exports = Object.freeze({
  TOKEN: '1085778444:AAFSk-tsJEBXNkGuKBOB8t8VxacY19zJxQ8', //required
  ARIA_SECRET: 'bhadoo', //change as per needs.
  ARIA_DOWNLOAD_LOCATION: '/app/downloads)', //-leave as it is
  INDEX_DOMAIN: 'https://thehiddenkia.veis.workers.dev/DaNi/', // replace with your index domain. use https://github.com/ParveenBhadooOfficial/go-drive
  ...
  GDRIVE_PARENT_DIR_ID:  '12V1A3mu_QMi3LapSRmz0gZyquoYn-de_', // for directorty eg. https://drive.google.com/drive/folders/1p7pHhSh2yboWePmo53DnVr3xkAYiojP9 use 1p7pHhSh2yboWePmo53DnVr3xkAYiojP9
  ...
  AUTHORIZED_CHATS: [-1001462908084],	// Telegram chat IDs. Anyone in these chats can use the bot. Add https://t.me/YourTGid_Bot to Group and click /id
  ...
  DOWNLOAD_NOTIFY_TARGET: {  // Information about the web service to notify on download completion. not required
    ...
    COMMANDS_USE_BOT_NAME: {
      ...
      NAME: "@LooCH_CLouD_04_BoT" //Enter your Bot Username here if above is set to true.
    }
});
